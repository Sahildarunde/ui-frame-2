        ...
        <div className="flex flex-col justify-between md:w-1/12 h-screen bg-[#2e3440] fixed items-center">
            <div>
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div className="h-10 w-10 bg-slate-400 flex justify-center items-center rounded-full"><Papers /></div>
                    <div className="h-10 w-10  flex justify-center items-center rounded-full"><Settings /></div>
...
function Shift(){
    return <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="gray" className="size-6">
